...
def test_regression_defaults_remain_eval1000_without_item_stats() -> None:
    assert list(DEFAULT_TASK_NAMES) == list(EVAL1000_TASK_BUILDERS)
    assert "ml-1m_rating_eval_users1000_seed0" in DEFAULT_TASK_NAMES
