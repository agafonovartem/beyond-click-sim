...
"""Run MovieLens-1M Qwen3.6-27B interaction prediction on local vLLM ports.

Methods are run sequentially. Within each method, task variants run in parallel
and each active task checks out one local vLLM client from the pool.
"""
...
METHOD_ORDER = (
    ...
    "agent4rec_yes_no_vllm_qwen36_27b_taste_gpt4o_mini_full",
    "agent4rec_yes_no_vllm_qwen36_27b_traits_full",
...
def main() -> None:
    ...
    batch_root = output_root / f"{run_id}_ml1m_qwen36_27b_local_parallel"
...
def _run_method(
    ...
    *,
    ...
    if method_name == "llm_yes_no_vllm_qwen36_27b_with_item_stats_full":
    ...
    if method_name == "agent4rec_yes_no_vllm_qwen36_27b_taste_gpt4o_mini_full":
    ...
    if method_name == "agent4rec_yes_no_vllm_qwen36_27b_traits_full":
        return agent4rec_yes_no.run_method(
            task,
            output_dir,
            method_name=method_name,
