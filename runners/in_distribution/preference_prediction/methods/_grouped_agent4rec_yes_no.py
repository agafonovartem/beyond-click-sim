"""Preference-local copy of the grouped Agent4Rec yes/no runner.

Intentionally duplicated from interaction prediction so protocol changes do not
propagate implicitly across experiment boundaries.
"""
